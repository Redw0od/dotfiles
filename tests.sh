...
cmd "shell_utility_status echo"; echos ""
cmd "shell_utility_status FAILS"; echos ""
cmd "shell_utilities \${UTILITIES[@]}"; echos ""
cmd "array_unique \${UTILITIES[@]}"; echos ""
cmd "curl_bearer ${KIBANA[LEGION]} ${APIKEYS[LEGION]}"; echos ""
cmd "randpw"; echos "\n" +
cmd "randpw 80"; echos "\n" +
